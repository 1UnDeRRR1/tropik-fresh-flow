...
//
// P1 stabilization: invalidations are debounced (~300ms) so a burst of
// postgres_changes events (e.g. a single refusal touching multiple tables)
// collapses into a single round of refetches instead of a refetch storm.
