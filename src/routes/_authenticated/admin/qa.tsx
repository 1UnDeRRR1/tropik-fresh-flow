...
const CHECKS: { group: string; items: Check[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "c11", title: "Факт / Розподілено / Залишок", desc: "Лічильники в кожній картці товару оновлюються миттєво при зміні значень.", link: { to: "/distribution", label: "Розподіл" } },
      { id: "c12", title: "Блокування при перевищенні Факт", desc: "Якщо розподілено > Факт → червона підсвітка та AlertDialog при збереженні.", link: { to: "/distribution", label: "Розподіл" } },
    ],
  },
  {
