            ...
            <div className="rounded-md border border-border bg-muted/30 p-3 space-y-2">
              ...
              <div className="text-xs text-muted-foreground">
                {selectedResponsibleManagerId
                  ? "Нове предложение буде створене від імені вибраного відповідального менеджера."
                  : "Нове предложение буде створене з відповідальним у статусі очікує призначення."}
              </div>
            </div>
          )}
