...
REVOKE EXECUTE ON FUNCTION public.archive_resolver_run(date, uuid) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.archive_resolver_run(date, uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.archive_resolver_run(date, uuid) FROM authenticated;
